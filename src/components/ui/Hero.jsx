  ...
  return (
    <section>
      <div className="flex flex-col items-center gap-10 pb-20 pt-10 lg:flex-row lg:gap-1.5 lg:pb-24 lg:pt-20 xl:justify-between">
        <div>
          <p className="mb-6 w-fit rounded-full bg-green px-7 py-3.5 text-base font-medium leading-[0.64] text-green-dark xl:mb-9 xl:px-10 xl:text-2xl xl:leading-[0.64]">
            No. 1 in Indonesia
          </p>
          <Title className="mb-2 lg:mb-4 lg:max-w-[350px] xl:max-w-[527px]">
            Make it easy for your Umrah worship with Al Nasr Travel
          </Title>
          <SubTitle className="mb-4 lg:mb-8 lg:max-w-[450px] xl:max-w-[645px]">
